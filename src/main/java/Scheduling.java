...
public class Scheduling {
    ...
    try {
      ...
      while ((line = in.readLine()) != null) {
        ...
        if (line.startsWith("process")) {
          ...
          int lotteryTicketsCount = Common.s2i(st.nextToken());
          X = Common.R1();
          while (X == -1.0) {
            X = Common.R1();
          }
          ...
          processVector.addElement(new Process(cputime, ioblocking, 0, 0, 0,
                  blockingDuration, lotteryTicketsCount, processVector.size()));
        }
  ...
  public static void main(String[] args) {
    int i = 0;
    args = new String[1];
    args[0] = "src/main/java/scheduling.conf";
    ...
    if (processVector.size() < processnum) {
      ...
      while (processVector.size() < processnum) {
        ...
        processVector.addElement(new Process(cputime,i * 100,0,0,0,
                blockingDuration, i * 5, processVector.size()));
        i++;
      }
    }
